...
[
        ...
        ["Box_FIA_Support_F",[1.125,-1.625,0.601674],0,{_this call randomCrateLoadOut;}],
        ["Box_IND_WpsSpecial_F",[8.125,1.875,0.722088],0,{_this call randomCrateLoadOut;}],
        ["Box_IND_WpsLaunch_F",[5.75,1.875,0.722088],0,{_this call randomCrateLoadOut;}],
        ["Box_IND_Grenades_F",[-0.875,-2.75,3.12652],0,{_this call randomCrateLoadOut;}],
        ["Box_IND_Support_F",[-0.875,-5.25,3.12652],0,{_this call randomCrateLoadOut;}]
]
